...
def make_step(img, model, control=None, distance=objective_L2,sigma=None):
...
def dream_fc(model,
    ...
    for octave, octave_base in enumerate(octaves[::-1]):
        ...
        out = make_step(input_oct, model, control, distance=distance,sigma=sigma[octave])
